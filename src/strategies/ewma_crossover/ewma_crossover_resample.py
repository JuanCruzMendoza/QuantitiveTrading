...
from src.robustness_tests.monte_carlo_resample import monte_carlo_resample
...
monte_carlo_resample(
    ...
    n_simulations=10,
    bt_kwargs=bt_params,
    log_filename='src/strategies/ewma_crossover/monte_carlo_resample.log',
    plot_file='src/strategies/ewma_crossover/monte_carlo_resample.png')